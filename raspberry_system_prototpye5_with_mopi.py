...
connect pin 26 and pin 19 for active mode
connect pin 26 and ground for debug mode
...
def takepicture(value):
    ...
    print(i)
    GPIO.output(20,GPIO.HIGH) #lightbulb
    sleep(0.5)
    ...
    camera.stop_preview()
    sleep(0.5)
    GPIO.output(20,GPIO.LOW) #lightbulb
...
def setupgpio():
    ...
    GPIO.setup(20,GPIO.OUT) #lightblub
    GPIO.setup(26,GPIO.IN) #input signal for debug or non debug
    GPIO.setup(19,GPIO.OUT) #setting high for easy access
    GPIO.output(19,GPIO.HIGH) #setting high for easy access
...
def checkmode():
    ...
    operationmode = GPIO.input(26) #detects the input of 26
